...
import { ToDoList } from '../../src/apps/AccelerationHQ/components/ToDoList'

const todos = [ 'Get a job', 'Get a job', 'Fix this app', 'Build these components' ]
storiesOf(componentLibraryRoot, module).addDecorator(withKnobs).addDecorator(centered)

storiesOf(`${componentLibraryRoot}/To Do List`, module)
	.addDecorator(centered)
	.addDecorator(withInfo)
	.add('FPO', () => <ToDoList todos={todos} />, {
